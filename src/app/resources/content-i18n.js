...
const createI18nContent = (t) => {
    const person = {
        ...
        location:  'Asia/Uzbekistan',        // Expecting the IANA time zone identifier, e.g., 'Europe/Vienna'
    ...
    const social = [
        ...
        // Import new icons in /once-ui/icons.ts
        {
            name: 'GitHub',
            icon: 'github',
            link: 'https://github.com/shakhhero',
        },
        {
            name: 'LinkedIn',
            icon: 'linkedin',
            link: 'https://uz.linkedin.com/in/shaxboz-erkinov-89286829b',
        },
        {
            name: 'X',
            icon: 'x',
        ...
        },
        {
            name: 'Email',
            icon: 'email',
            link: 'mailto:UzShakhboz@gmail.com',
        },
    ]
